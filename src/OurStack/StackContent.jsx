...
const StackContent = () => {
  return (
    <div>
      <div className='flex mx-32 h-32 items-center '>
        <div className='w-[166px] items-center h-[94px] mx-auto'>
      ...
      <div  className='flex mx-80 h-32 items-center'>
        <div className='w-[166px] items-center h-[94px] pt-6 mx-auto'> 
            <img src={python} alt="" />
        </div>
        <div className='w-[166px] items-center h-[94px] pt-6 mx-auto'>
            <img src={rails} alt="" />
        </div>
        <div className='w-[166px] items-center h-auto pt-6 mx-auto'>
            <img src={Go} alt="" />
        </div> 
        <div className='w-[166px] items-center h-[94px] pt-6 mx-auto'><img src={mongodb} alt="" /></div>
      </div>
    </div>
  )
}
