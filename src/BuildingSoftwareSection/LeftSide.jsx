...
const LeftSide = ({person}) => {
  return (
    ...
    <p className='text-2xl lg:text-[28px] text-[#1a202c] font-bold pb-[30px]'>Build the right team to scale</p>
    <p className='text-[18px] leading-7 lg:w-[534px] pb-[30px]'>Finding the right talent is not easy. We help you find the talent that suits your needs, follows your processes, and sticks with you long term (not the case with freelancers</p>
    <p className='text-[#2d3748] lg:text-[18px] font-[400] pb-[30px]'>Our <span className='text-[#b0397e] pb-[30px] leading-7'>delivery model</span>  helps you cut costs and deliver within <br></br> budget.</p>
